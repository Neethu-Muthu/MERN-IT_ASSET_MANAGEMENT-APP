    ...
    return (
        <>
            <header className="bg-blue-100 shadow-md py-4 px-6 flex justify-between items-center">
                <div className="text-xl font-bold">ITAM Application</div>
                <nav className="space-x-4">
                    <a href="/sign-up" className="text-gray-600 hover:text-gray-900">Signup</a>
            ...
            <section className="bg-cover bg-center bg-hero text-black py-20 px-6">
                <div className="max-w-4xl mx-auto text-center">
                    <h1 className="text-5xl font-bold mb-4">Welcome to Asset Management Application</h1>
                    <p className="text-1xl text-slate-900 mb-8">Efficiently track and manage your assets with our simple and intuitive application.</p>
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <ul className="space-y-4">
                        <li className="flex items-center">
                            <img src="/src/images/data-science.png" alt="Feature Icon" className="mr-1 w-10 h-8" />
